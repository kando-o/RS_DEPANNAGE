...
export default function ContactForm() {
  return (
    <section id="contact" className="py-12 px-20 max-w-7xl mx-auto">
      <h2 className="text-3xl md:text-4xl bg-gradient-to-r from-purple-600 to-orange-400 text-transparent bg-clip-text font-bold mb-2 text-center">Prenez votre rendez-vous maintenant !</h2>
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
        ...
        <form name="contact" method="POST" data-netlify="true" className="w-full lg:w-2/3 grid gap-4 md:gap-6">
          ...
          <button type="submit" className="flex items-center justify-center px-4 py-2 md:px-6 md:py-3 bg-zinc-900 text-white font-medium rounded-md hover:bg-black text-sm md:text-base transition duration-300 ease-in-out">
            Send Message

  ...
  const features = [
    {
      ...
      title: "Vente Rapide",
      description:
        "En moins de 5 minutes, obtenez gratuitement votre estimation, planifiez un rendez-vous avec un professionnel du réseau AutoXP, et vendez votre voiture en moins d'une heure.",
    },
    {
      icon: FaCreditCard,
